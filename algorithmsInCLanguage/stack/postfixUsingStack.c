// Algorithm for postfixUsingStack

// step 1: If operand, then print the operand
// step 2: If operator come, first check if stack empty push the operator in the stack else step 3.
// step 3: If operator come, if the operator in the stack is having higer preferance than the new operator, then pop the element util the preference change
// step 4: last pop each element and print the elements 
